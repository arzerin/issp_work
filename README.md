...
<table width="100%">
   ...
   <tr>
    ...
    <tr>
        ...
        <td  width="60%">
            I tried to build a model on Shoplifting using Kaggle Shoplifting dataset, I tried to use aall the below models to find out which accuracy is good enough.
